...
export default function LandingPage() {
    ...
    return (
        ...
        {/* Main content */}
        <div
            className={`glass border border-white/20 rounded-2xl p-6 sm:p-10 md:p-12 w-full max-w-3xl text-center shadow-xl transition-all duration-700 ease-out ${
        ...
        >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-200 mb-6 max-w-xl mx-auto">
            ...
            <Link to="/about">
                ...
                variant="outline"
                size="lg"
                className="border-white/20 bg-white/10 hover:bg-white/20 text-base sm:text-lg px-6 sm:px-8 py-4 h-auto"
                >
                Learn More
                </Button>
            </Link>
            ...
            {["Simple Task Management", "Priority Tracking", "Deadline Reminders"].map((feature, i) => (
                <div key={i} className="flex items-center justify-center gap-2 text-gray-800 dark:text-gray-200">
        ...
        <div
            className={`mt-6 sm:mt-8 text-sm text-center text-gray-500 transition-opacity duration-1000 ease-out ${
